...
namespace _3DTools
{
    public class TrackballDecorator : Viewport3DDecorator
    {
        ...
        public void Reset()
        {
            ...
            _scale.ScaleZ = 1;
            _rotation.Angle = 0;
            _rotation.Axis = new Vector3D(1,1,1);
        }
        ...
        protected override void OnMouseDown(MouseButtonEventArgs e)
        {
            ...
            _previousPosition3D = ProjectToTrackball(ActualWidth,
                                                     ActualHeight,
                                                     _previousPosition2D);
            if (Mouse.Captured == null && e.LeftButton== MouseButtonState.Released)
            {
                ...
                if (viewport3D != null)
                {
                    if (viewport3D.Camera != null)
                    {
                        ...
                        if (viewport3D.Camera.Transform != _transform)
                        {
                            ...
                            //UIElement3D uie = (UIElement3D)viewport3D.Children[0];
                            //uie.Transform = _transform;
                        }
                    }
                }
            }
